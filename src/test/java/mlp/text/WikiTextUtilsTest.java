...
public class WikiTextUtilsTest {
    ...
    public void extractPlainText_wikiLinks() {
        String input = "In [[quantum mechanics]], the '''Schrödinger equation''' is a [[partial differential equation]] "
    ...
    public void extractPlainText_removeTagsAndItalic() {
        String input = "For a constant potential, ''V'' = ''V''<sub>0</sub>, the solution is oscillatory for ''E'' > "
                + "''V''<sub>0</sub> and exponential for ''E'' < ''V''<sub>0</sub>, corresponding to energies that "
