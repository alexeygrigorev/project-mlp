...
public class SentenceUtils {
    ...
    /**
     * Joins a set of PactWords, described by a pattern, together with a given tag into a new Word within the
     * sentence. A pattern is a string containing tags and wildcards where every part is separated by a space
     * character.
     * 
